...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  // Auto-recover from occasional blank-screen states is disabled because it causes data loss while working.
  ...
  return (
    <div className="min-h-[100svh] flex flex-col overflow-x-hidden w-full">
      ...
      <main className="flex-1 pt-[calc(4rem+env(safe-area-inset-top,0px))] sm:pt-[calc(3.5rem+env(safe-area-inset-top,0px))] pb-[calc(4rem+env(safe-area-inset-bottom,0px))] lg:pb-0 w-full relative">
