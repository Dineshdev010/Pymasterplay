...
const careerPaths = [
  ...
  },
  {
    ...
    salary: "$70K — $130K",
    description: "Build high-performance web apps, async APIs, and enterprise microservices with Python.",
    skills: ["API Design & Security", "Async & Background Tasks", "Docker & Kubernetes", "Modern Frontend (React/Tailwind)"],
    tools: ["FastAPI & Django", "Celery & Redis", "PostgreSQL", "Docker", "PyTest"],
    lessons: [
      { label: "Python Web Foundations", tier: "beginner" },
      { label: "Flask & Jinja2 Basics", tier: "beginner" },
      { label: "SQLAlchemy & ORM", tier: "beginner" },
      { label: "JWT & OAuth2 Auth", tier: "advanced" },
      { label: "FastAPI Async Routes", tier: "advanced" },
      { label: "Frontend Integration", tier: "advanced" },
      { label: "Celery & Task Queues", tier: "master" },
      { label: "Security & Hardening", tier: "master" },
      { label: "PyTest & QA Suites", tier: "master" },
      { label: "GraphQL & Microservices", tier: "master" },
      { label: "Docker & CI/CD", tier: "master" },
      { label: "Enterprise K8s Apps", tier: "master" },
    ],
    projects: ["Real-time Multi-tenant App", "Microservices API Gateway", "E-commerce Engine"],
  },
  {
    id: "ai-ml",
    title: "AI & ML",
...
const roadmapThemeByPathId: Record<string, {
  ...
  "agentic-ai": {
    badgeClass: "bg-expert-purple/10 border-expert-purple/30 text-expert-purple",
    pulseClass: "bg-expert-purple",
    sectionGlowA: "bg-[radial-gradient(ellipse_at_20%_50%,hsl(280_65%_46%_/_0.18),transparent_60%)]",
    sectionGlowB: "bg-[radial-gradient(ellipse_at_80%_20%,hsl(270_65%_40%_/_0.10),transparent_50%)]",
    sectionGlowC: "bg-[radial-gradient(ellipse_at_50%_80%,hsl(280_55%_32%_/_0.09),transparent_50%)]",
    cardIdleClass: "hover:border-expert-purple/40 hover:shadow-expert-purple/10",
    detailPanelClass: "bg-gradient-to-br from-card via-card to-expert-purple/5",
  },
  "english-mastery": {
    badgeClass: "bg-primary/10 border-primary/30 text-primary",
    pulseClass: "bg-primary",
    sectionGlowA: "bg-[radial-gradient(ellipse_at_20%_50%,hsl(212_92%_45%_/_0.18),transparent_60%)]",
    sectionGlowB: "bg-[radial-gradient(ellipse_at_80%_20%,hsl(212_92%_45%_/_0.10),transparent_50%)]",
    sectionGlowC: "bg-[radial-gradient(ellipse_at_50%_80%,hsl(212_92%_45%_/_0.09),transparent_50%)]",
    cardIdleClass: "hover:border-primary/40 hover:shadow-primary/10",
    detailPanelClass: "bg-gradient-to-br from-card via-card to-primary/5",
  },
  "system-design": {
    ...
    sectionGlowA: "bg-[radial-gradient(ellipse_at_20%_50%,hsl(260_65%_46%_/_0.18),transparent_60%)]",
    sectionGlowB: "bg-[radial-gradient(ellipse_at_80%_20%,hsl(260_65%_40%_/_0.10),transparent_50%)]",
